...
export const workers: Worker[] = [
  {
    ...
    services: [
      "House Wiring & Electrical Fixes",
      "Plumbing & Pipe Repair",
      "Leak Detection & Sanitary Work",
      "Inverter & Battery Setup",
      "Water Tank & Pump Installation",
      "Emergency Electrical & Plumbing Work",
    ],
    verified: true,
    available: true,
  ...
  },
  {
    ...
    services: [
      ...
      "Leak Detection & Drainage Fixes",
      "Bathroom Sanitary Fittings",
      "Water Tank & Motor Setup",
      "Switchboard & Wiring Maintenance",
    ],
    verified: true,
    available: true,
  ...
  },
  {
    ...
    services: [
      ...
      "Emergency Electrical & Plumbing Support",
    ],
    verified: true,
    available: true,
