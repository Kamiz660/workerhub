                      ...
                      return (
                        ...
                        >
                          <span className="flex items-center gap-2 text-zinc-500">
                            <MapPin className="h-3.5 w-3.5 text-zinc-400" /> {town}
                          </span>
                          <span className="text-[9px] font-semibold px-1.5 py-0.5 rounded bg-zinc-200/90 text-zinc-600">
                  ...
                  <div 
                    ...
                    {filtered.map((category) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <span className="text-lg flex-shrink-0 grayscale opacity-60">{category.icon}</span>
                            <span className="font-semibold text-zinc-500 text-sm">{t(`categories.${category.id}`)}</span>
                          </div>
                          <span className="text-[9px] font-semibold px-1.5 py-0.5 rounded bg-zinc-200/90 text-zinc-600">
                            {language === "en" ? "Coming Soon" : "ഉടൻ വരും"}
                          </span>
                    ...
                    {filteredTowns.map((town) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="text-[10px] font-semibold px-2 py-0.5 rounded bg-zinc-200/90 text-zinc-600">
                            {language === "en" ? "Coming Soon" : "ഉടൻ വരും"}
                          </span>
                        </div>
                      );
