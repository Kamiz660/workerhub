...
- **Mobile How to Use Strip**: Horizontal step indicator located within the hero area on mobile. Features raw icons directly without background circles/boxes, arrow (`ArrowRight`) connectors in between steps, low-contrast text labels, and no numbered indicator circles.
